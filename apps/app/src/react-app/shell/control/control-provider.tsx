...
export function OpenworkRouteControlActions() {
  ...
  const actions = useMemo<OpenworkControlAction[]>(() => [
    ...
    },
    {
      ...
      label: "What can CocodeAI do?",
      description: "List the main capabilities of CocodeAI.",
      sideEffect: "none",
      execute: () => ({
        capabilities: [
          ...
          { id: "voice", label: "Voice mode", description: "Talk to CocodeAI with real-time voice using OpenAI Realtime." },
          ...
          { id: "sharing", label: "Share sessions", description: "Share workspace sessions with collaborators via CocodeAI Cloud." },
        ],
