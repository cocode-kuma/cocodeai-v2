      ...
      <PageContainer>
        <PageHeader>
          ...
          >
            ...
            Setup complete — CocodeAI is ready
          </div>
      ...
      <Page>
        ...
        <PageContainer>
          <PageHeader>
            ...
            <PageDescription>
              Restart CocodeAI once to finish applying {orgName || "your workspace"}&apos;s name and app icon everywhere.
            </PageDescription>
      ...
      <PageContainer>
        ...
        <PageHeader>
          {prepared ? (
            ...
            >
              <CheckCircle2 className="size-3.5" />
              Setup complete — CocodeAI prepared this workspace
            </div>
          ) : null}
          <div className="mx-auto flex size-14 items-center justify-center rounded-2xl border border-dls-border bg-dls-hover">
            <BuildingOffice2Icon className="size-7 text-foreground" />
          ...
          <PageContent>
            <Empty className="h-fit flex-none">
              <EmptyHeader>
                ...
                <EmptyDescription>
                  Add AI providers or marketplaces from the CocodeAI Cloud dashboard.
                </EmptyDescription>
              </EmptyHeader>
              <EmptyContent>
                <Button
