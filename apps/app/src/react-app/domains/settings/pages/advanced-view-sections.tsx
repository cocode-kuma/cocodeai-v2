  ...
  return (
    <LayoutSection>
      <LayoutSectionHeader>
        ...
        <LayoutSectionDescription>
          Technical details for CocodeAI Cloud MCP delivery. Tokens and Authorization headers are redacted before display or copy.
        </LayoutSectionDescription>
      </LayoutSectionHeader>

      <LayoutSectionItem>
        <LayoutSectionItemHeader>
          <LayoutSectionItemTitle>CocodeAI Cloud MCP health</LayoutSectionItemTitle>
          <LayoutSectionItemDescription>
        ...
        {props.cloudMcpHealth ? (
          <div className="space-y-2 rounded-xl border border-gray-6 bg-gray-1/60 p-3">
            <div className="grid gap-2">
              ...
              {compatibility ? (
                <>
                  <DiagnosticRow label="CocodeAI versions" value={`server ${formatMaybe(compatibility.openwork.serverVersion)}; app ${formatMetadataRecord(compatibility.openwork.app)}`} />
