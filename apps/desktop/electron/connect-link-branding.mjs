...
/**
 * @param {Partial<import("@cocodeai/types/desktop-ipc").DesktopBootstrapConfig>} config
...
/**
 * @param {import("@cocodeai/types/connect-link").ConnectLinkClaims} claims
 * @param {{
 *   persistBootstrap: (
 *     config: Partial<import("@cocodeai/types/desktop-ipc").DesktopBootstrapConfig>
 *   ) => Promise<import("@cocodeai/types/desktop-ipc").DesktopBootstrapConfig>,
