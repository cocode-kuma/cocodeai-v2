      ...
      <section className="hero-card panel">
        <div className="hero-copy">
          ...
          <p>
            ...
            the gradients that `@cocodeai/ui/react` will render anywhere else in the repo.
          </p>
        </div>
      ...
      <section className="footer-grid">
        ...
        <div className="panel code-panel">
          ...
          <div className="pill-stack">
            <code className="import-pill">@cocodeai/ui/react</code>
          </div>
          <pre>{`import { PaperMeshGradient, PaperGrainGradient } from "@cocodeai/ui/react"
    ...
    <article className="panel preview-card">
      <div className="gradient-surface">
        ...
        <div className="surface-copy">
          <span className="eyebrow on-dark">@cocodeai/ui/react</span>
          <h2>{title}</h2>
          <p>{subtitle}</p>
        </div>
      </div>
